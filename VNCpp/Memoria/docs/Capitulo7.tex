...
Para la realización de estas mediciones se ha utilizado el software Wireshark (Ver sección 1.1.10), mediante el cual se ha podido sniffear los paquetes, para posteriormente, recoger los resultados.\\
